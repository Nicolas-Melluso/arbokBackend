...
router.get(
  "/nameapi/:movie_name/:page",
  auth,
  validate,
  moviesController.searchMovieByNameAPI
);
router.get(
  "/namedb/:movie_name",
  auth,
  validate,
  moviesController.searchMovieByNameDB
);
router.get(
  "/fill/:page([0-9]*)",
  auth,
  validate,
  moviesController.fillAdminAdd
);
...
router.delete(
  ...
  auth,
  validate,
  moviesController.deleteGenreMovieByID
);

// /* updaters */
router.put("/:id", auth, validate, moviesController.update); // by body - parser
